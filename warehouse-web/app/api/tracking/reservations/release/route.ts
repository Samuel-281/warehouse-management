...
import { releaseTrackingBarcodeReservations } from "@/lib/services/tracking-reservation-service";
...
export async function POST(request: Request) {
  try {
    ...
    return ok(await releaseTrackingBarcodeReservations({ ...input, userId: user.id }));
  } catch (error) {
