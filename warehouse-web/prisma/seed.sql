...
VALUES
  ('30000000-0000-0000-0000-000000000001', 'ZC-001', '市区总仓', 'MAIN', NULL, '周主管', 'ENABLED', now(), now()),
  ('30000000-0000-0000-0000-000000000002', 'FC-101', '东山县分仓', 'BRANCH', '30000000-0000-0000-0000-000000000001', '刘库管', 'ENABLED', now(), now()),
  ('30000000-0000-0000-0000-000000000003', 'FC-202', '南河镇分仓', 'BRANCH', '30000000-0000-0000-0000-000000000001', '陈库管', 'ENABLED', now(), now())
ON CONFLICT (code) DO NOTHING;

INSERT INTO storage_locations (id, "warehouseId", zone, code, name, status, "createdAt", "updatedAt")
VALUES
  ('31000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', 'A区', 'A-01-01', 'A区一排一层', 'ENABLED', now(), now()),
  ('31000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000001', 'B区', 'B-02-01', 'B区二排一层', 'ENABLED', now(), now()),
  ('31000000-0000-0000-0000-000000000003', '30000000-0000-0000-0000-000000000002', '常温区', 'C-01', '东山常温一号位', 'ENABLED', now(), now()),
  ('31000000-0000-0000-0000-000000000004', '30000000-0000-0000-0000-000000000003', '暂存区', 'T-01', '南河暂存一号位', 'ENABLED', now(), now())
